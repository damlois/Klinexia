      ...
      <div className="mx-auto max-w-[1280px] px-8">
        <div className="flex flex-col items-center gap-8">
          <div className="flex flex-col items-center gap-8 text-center">
            <img src="/footer-logo.svg" alt="Klinexia" className="h-12 w-auto" />
          ...
          <nav className="flex flex-wrap items-center justify-center gap-8">
            {navLinks.map((link) => (
              <a key={link.href} href={link.href} className="font-medium leading-[24px] text-[16px] text-white/85 transition-colors hover:text-white [font-family:var(--font-manrope),sans-serif]">
                {link.label}
              </a>
            ))}
          </nav>
        ...
        <div className="mt-8 flex flex-col gap-8">
          ...
          <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
            ...
            <div className="flex items-center justify-center gap-4 font-normal leading-[24px] text-[16px] text-white sm:justify-end [font-family:var(--font-manrope),sans-serif]">
